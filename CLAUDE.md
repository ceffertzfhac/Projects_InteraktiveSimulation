...
- **Physik-Logo (FB 8):** Jede Sim zeigt das Logo „Lehr- und Forschungsgebiet Physik“ in der Topbar **rechts neben** `<span class="inst">FH Aachen – FB 8 – Physik</span>` als `<img src="../shared/img/logo_physik_mint.png" class="topbar-logo" alt="…" title="…">` (41 px, leicht transparent; Klasse in `shared/css/design-system.css`, im Scaffold enthalten). Übersichtsseiten (`AllAnimations/`, `Webpage/index.html`) prominenter als `.header-logo` (62 px) links vor dem Brand-Text. Web-Fassung `shared/img/logo_physik_mint.png` (160 px hoch), Original in `shared/img/src/` — nicht das Original einbinden. `shared/img/*.png` wird von `sync-webpage.sh` mitgespiegelt.
