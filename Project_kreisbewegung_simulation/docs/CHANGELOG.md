...
Diagramme"-Pille bei gewählter Bahnkurve fühlte sich trotz Tooltip (v1.3.0)
...
- **`updateStackedAvailability()` entfernt** (disable/tooltip-Logik aus
  v1.3.0 obsolet) zugunsten von `handleDiagramModeSwitch()`, das nur beim
  tatsächlichen Moduswechsel-Event greift statt bei jedem Reset.
