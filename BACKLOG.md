...
| I10 | Kritische Physik-Review repo-weit (Sim für Sim) | **Should** — die kritische Physik-Review von Atwood-Energie (Session 2026-07-10) fand 5 reale Bugs (B14–B18) in einer bereits „fertig polierten" Sim: invertiertes v/a-Vorzeichen gegenüber der Höhen-Konvention, Diagrammtyp ignorierte das Subjekt, doppelte/verschwundene Beschriftungen durch falsche SVG-Zeichenreihenfolge. Gleiches Fehlermuster (precompute + Koordinatentransformation, SVG-Z-Order vor opaken Elementen) ist in weiteren `precompute()`-Sims plausibel. **Reihenfolge (Sprint, 2026-07-10 beschlossen):** 1. Freier Fall/Senkrechter Wurf (kanonische Referenz-Sim) → 2. Schräger Wurf → 3. Zykloide → 4. Kreis-/Spiralbewegung → 5. Rollende Körper (komplexeste Physik, zuletzt). Methodik je Sim: `physics.js`/`state.js`/`render.js` lesen, Energie-/Impulserhaltung numerisch verifizieren (Node-Testskript gegen `precompute()`), Vorzeichenkonventionen (Position vs. Geschwindigkeit vs. Beschleunigung) gegen die Höhen-/Achsenkonvention der Sim gegenprüfen, SVG-Dokumentreihenfolge auf deckende Elemente (Blenden/Hintergründe) vor beweglichen/beschrifteten Objekten prüfen. Funde als neue `B#` anlegen, sofort fixen, CHANGELOG+Version je Sim bumpen. *(PO-Wunsch 2026-07-10)* |
...
- **Bugs:** 2 offen (B4, B5) — B1, B2, B3 erledigt (Session 2026-07-07); B7–B11 erledigt (Kreis-Spiral v1.1.0, 2026-07-08); B12 erledigt (Kreis-Spiral v1.1.10, 2026-07-08); B6 erledigt (3-Massen v1.2.4, 2026-07-08); B13 erledigt (Atwood-Energie v1.2.2, 2026-07-10); B14–B19 erledigt (Atwood-Energie/Atwood/Schräger Wurf, kritische Physik-Review I10, Session 2026-07-10)
...
- **Erledigt (historisch):** 57 (M2, M3 — Sprint 2; T5, I2, S2, R0–R9 — Sprint 3; I4 — Sprint 4a; M1, M4 — Sprint 4b; M5 — Sprint 4e; T8, T3, T7, T2, B1, B2, B3, T4, W1, W2, W3 — Session 2026-07-07; M6, M6b — Session 2026-07-08; B7, B8, B9, B10, B11, FX6 — Kreis-Spiral v1.1.0, 2026-07-08; B12 — Kreis-Spiral v1.1.10, 2026-07-08; FX7 — Kreis-Spiral v1.2.0, 2026-07-08; W1 modular migriert, FAG1, FAG2 — Ableitung v1.0.0–v1.2.2, 2026-07-08; B6 — 3-Massen v1.2.4, 2026-07-08; FX1 — Kreis-Spiral v1.2.1, 2026-07-08; FAE9–13, B13 — Atwood-Energie v1.2.7–v1.2.9/v1.2.2, Session 2026-07-09/10; FAE14, B14–B19 — Atwood-Energie/Atwood/Schräger Wurf, kritische Physik-Review I10, Session 2026-07-10)
