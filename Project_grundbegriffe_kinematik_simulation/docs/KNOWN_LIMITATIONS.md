# Known Limitations — Grundbegriffe der Kinematik
...
- **Kein Diagramm-Hover (→ BACKLOG I13.2 — Won't):** Diese Werkzeug-Sim
  ...
  Hover-at-x mit adaptiertem Tooltip (Bahnpunkt-Werte s/v/a statt „Wert bei
  t") wurde im Rahmen von I13.2 erwogen und auf ausdrückliche
